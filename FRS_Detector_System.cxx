...
void FRS_Detector_System::FRS_Timestamp_Module(int ID){
...
void FRS_Detector_System::FRS_Scaler_Module(int ID){
...
void FRS_Detector_System::FRS_775_TDC_785_ADC_Modules(int ID){
...
void FRS_Detector_System::FRS_Rest_Of_Unpacking(int ID){
...
//    RAW->set_DATA_MUSIC(de, de_cor); //Causes crash
 //   RAW->set_DATA_SCI(sci_l, sci_r, sci_e, sci_tx, sci_x); //Causes crash
